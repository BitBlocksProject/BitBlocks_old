...
{
    return GetBoolArg("-testnet", false) ? 21327 : 21327;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "Stop bitblocks server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "bitblocks server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: bitblocks-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("bitblocks-rpclist");
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use Bitblocksd";
    ...
    if (fUseSSL)
    {
        ...
        string strCiphers = GetArg("-rpcsslciphers", "TLSv1+BBK:!SSLv2:!aNULL:!eNULL:!AH:!3DES:@STRENGTH");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("bitblocks-rpchand");
