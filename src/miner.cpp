...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake, int64_t* pFees)
{
    ...
    // How much of the block should be dedicated to BBK-priority transactions,
    ...
    int64_t nFees = 0;
    {
        ...
        while (!vecPriority.empty())
        {
            ...
            // Prioritize by fee once past the priority size or we run out of BBK-priority
            // transactions:
            if (!fSortedByFee &&
