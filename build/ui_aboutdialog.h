...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitblocks", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitblocks</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The Bitblocks developers", Q_NULLPTR));
