...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 HIGH"));
        ...
        labelStake->setText(QStringLiteral("0 HIGH"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 HIGH"));
        ...
        labelImmature->setText(QStringLiteral("0 HIGH"));
