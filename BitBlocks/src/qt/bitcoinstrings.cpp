...
"for example: alertnotify=echo %%s | mail -s \"bitblocks Alert\" admin@foo."
"com\n"),
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Cannot obtain a lock on data directory %s.  bitblocks is probably already "
"running."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of bitblocks"),
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart bitblocks to complete"),
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Unable to bind to %s on this computer. bitblocks is probably already running."),
...
"your clock is wrong bitblocks will not work properly."),
